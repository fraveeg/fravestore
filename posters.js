// posters.js - Specific to Posters (Updated for single custom product & WhatsApp instruction & Add to Cart notification)
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!container || !productCountSpan || !notificationContainer) {
        console.error("posters.js: CRITICAL ERROR: Essential DOM elements not found. Page might not render correctly.");
        return;
    }
