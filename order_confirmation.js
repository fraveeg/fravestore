    ...
    function renderIndividualPosters(postersToRender) {
        ...
        postersToRender.forEach((poster) => {
            ...
            productDiv.innerHTML = `
                ...
                <div class="selected-count-bubble">${currentSelectedCount}</div>
            `;
            ...
            if (poster.isCustomizable) {
                ...
                if (addDesignBtn && removeDesignBtn) {
                    ...
                    customCheckbox && customCheckbox.addEventListener('change', () => {
                        ...
                        updateButtonStates();
                        // Re-render to update the display for this poster if its customization state changes
                        // We do a full re-render of ALL filtered products to ensure correct state propagation.
                        renderIndividualPosters(currentFilteredIndividualPosters);
                    });

                    imageInput && imageInput.addEventListener('change', () => {
                        updateButtonStates();
                        // Re-render to ensure any existing selected custom designs have their filenames updated.
                        renderIndividualPosters(currentFilteredIndividualPosters);
                    });
                }
            }
